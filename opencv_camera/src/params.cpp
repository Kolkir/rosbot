...
CameraParams ReadCameraParams(ros::NodeHandle& node_handle) {
  ...
  if (!node_handle.param("/opencv_camera/buffer_size", params.buffer_size,
                         100)) {
  ...
  if (!node_handle.param("/opencv_camera/out_queue_size", params.out_queue_size,
                         30)) {
  ...
  if (!node_handle.param("/opencv_camera/name", params.name,
  ...
  if (!node_handle.param("/opencv_camera/info_file_url", params.info_file_url,
                         std::string())) {
  ...
  if (!node_handle.param("/opencv_camera/camera_index", params.camera_index,
                         0)) {
  ...
  if (!node_handle.param("/opencv_camera/frame_width", params.frame_width,
                         640.0)) {
  ...
  if (!node_handle.param("/opencv_camera/frame_height", params.frame_height,
                         480.0)) {
  ...
  if (!node_handle.param("/opencv_camera/frame_rate", params.frame_rate,
                         15.0)) {
